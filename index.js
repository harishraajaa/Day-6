...
//     return `The product name is ${e.title} costs Rs.${e.price}`
// })
...
//Method-1- Single line return is not required

// let filereddata= products.filter((e)=>e.price<100)
// console.log(filereddata)

//Method-2 - Multi line funtion return line is required so that array gets added with the filtered data.
...
// let total= products.reduce((acc,i)=>{
//     return acc+i.stock
// },0)
...
//a.shift()
//a.unshift(7)// Adds the value in the begining
//a.shift()// Delete the value in begining
//a.push(10)// Inserts at end
//a.pop()//deletes the value at end
//out=a.slice(1,5)//start and end based out. Slice never affect the original
